...
<div class="mainDiv">
    ...
    <div class="paraElement right">
        <div>
            <h2>Chief Cadet Training Officer<br>(Chief CTO)</h2>
...
<div class="mainDiv">
    <div class="paraElement left">
        <div>
            <h2>Cadet Operations Group Commander</h2>
    ...
    <div class="imgElement right">
        <img src="images/announcingAwards.jpg" alt="Announcing awards as commander">
    </div>
</div>

<div class="mainDiv">
    <div class="imgElement left">
        <img src="images/ftPaintball.jpg" alt="In field during paintball tactical scenerios">
    </div>
    <div class="paraElement right">
        <div>
            <h2>Field Training<br>Distinguished Graduate</h2>
...
<div class="mainDiv">
    <div class="paraElement left">
        <div>
            <h2>Air Force Academy Free Fall<br>(AFAFF)</h2>
    ...
    <div class="imgElement right">
        <img src="images/freeFall.jpg" alt="With my flight at USAFA">
    </div>
</div>
