...
<div class="anchorLinks">
    <ul>
        <li class="airForce"><a class="anchor" data-link="airForce">Air Force</a></li>
        <li class="internships"><a class="anchor" data-link="internships">Internships</a></li>
        <li class="software"><a class="anchor" data-link="software">Software</a></li>
    </ul>
</div>
<br><br>
<a href="pdfView.php?pdf=documents/GarciaAxitResumeFall2022Public.pdf">
    <h1 class="mt-3 mb-2">My Resume</h1>
</a>

<section id="airForce" class="mt-5 mb-5">
    <h1 class="sectionHead text-center">Air Force</h1>
    <div class="variableDiv reveal reveallevel">
        <div class="imgDiv left reveal revealleft">
            <span class="helper"></span>
            <video style="max-height: 80vh;" controls>
                <source src="images/clcJody.mp4" type="video/mp4">
                Video of CLC cadets marching and singing military chant
            </video> <br>
            Fellow CTO leading cadets in military chants
        </div>
        <div class="textDiv right reveal revealright">
            <div>
    ...
    <div class="variableDiv reveal reveallevel">
        <div class="textDiv reveal revealleft left">
            <div>
                <h2>Cadet Operations Group Commander - Spring 2022</h2>
        ...
        <div class="imgDiv reveal revealright right">
            <span class="helper"></span>
            <img src="images/announcingAwards.jpg" alt="Announcing awards as commander"><br>
            Handing out monthly awards as commander of the unit
        </div>
    </div>
    <div class="variableDiv">
        <span class="reveal reveallevel" style="width: 80%; text-align:center">
    ...
    <div class="variableDiv reveal reveallevel">
        <div class="imgDiv reveal revealleft left">
            <span class="helper"></span>
            <img src="images/ftPaintball.jpg" alt="In field during paintball tactical scenerios"><br>
            Analyzing situation during a combat mission scenerio <br>at Camp Shelby, Mississippi
        </div>
    ...
    <div class="variableDiv">
        <span class="reveal reveallevel" style="width: 80%; text-align:center">
            Field training was an event where I was evaluated for everything that I had been learning for 3 years. The stress applied helped create me, as pressure creates diamonds, into the cadet officer I would become. Using my experiences in prior events, I was able to focus in my time there and learned the importance of helping out my team so that everyone can make it through those 2 weeks of evaluation and growth. Some of my fondest memories of AFROTC took place at field training, and it is an experience I am very proud to have completed.
        </span>
    </div>
    ...
    <div class="variableDiv reveal reveallevel">
        ...
        <div class="imgDiv reveal revealright right">
            <span class="helper"></span>
            <img src="images/freeFall.jpg" alt="With my flight at USAFA"><br>
            With my group mates after a 4500ft freefall in <br>Colorado Springs, Colorado
        </div>
    </div>
    <div class="variableDiv">
        <span class="reveal reveallevel" style="width: 80%; text-align:center">
...
<section id="internships" class="mt-5 mb-5">
    <h1 class="text-center sectionHead">Internships</h1>
    <div hidden class="variableDiv reveal reveallevel">
        <div class="imgDiv reveal revealleft left">
            <span class="helper"></span>
            <img src="images/ftPaintball.jpg" alt="In field during paintball tactical scenerios"><br>
            Analyzing situation during a combat mission scenerio <br>at Camp Shelby, Mississippi
        ...
        <div class="textDiv reveal revealright right">
            <div>
                <h2>Clarkson Aerospace ROTC Work Study Program <br>- Fall 2022-Spring 2023</h2>
                Field training is the 2 week training that all AFROTC cadets go through to get <b>evaluated</b> in their <b>leadership</b> capabilities within a controlled military environment. <br><br>
                Evaluations consists of
                <ul>
                    <li>academics, including full knowledge of the <a href="pdfView.php?pdf=documents/FTM_21.pdf">Field Training Manual (FTM)</a></li>
    ...
    <div class="variableDiv reveal reveallevel">
        ...
        <div class="imgDiv reveal revealright right">
            <span class="helper"></span>
            <img src="images/baylorExternship.jpg" alt="My profile photo for the externship"><br>
            My profile photo for the externship
        </div>
    </div>
    <div class="variableDiv">
        <span class="reveal reveallevel" style="width: 80%; text-align:center">
